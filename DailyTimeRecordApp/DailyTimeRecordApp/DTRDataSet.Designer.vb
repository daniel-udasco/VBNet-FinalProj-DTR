...
Namespace DTRDataSetTableAdapters
    ...
    Partial Public Class DTRTableAdapter
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As DTRDataSet.DTRDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As DTRDataSet.DTRDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DTRDataSet.DTRDataTable = New DTRDataSet.DTRDataTable()
